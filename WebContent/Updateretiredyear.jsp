...
<html>
	...
	<body>
		...
		<button type = "submit">AdminPage</button></form>
		</div>
		<form action ="Updateretiredyearservlet">
			Enter cap number:
			<input type ="text" name = "capno"  pattern ="[a-z]{1,}[0-9]{3,}" autofocus required 
            title = "Cap number must have minimum one character and three digit number"/>
            <br/> 
			<br><br>
			Enter retired year:
			<input type = "number" id ="retyear" name="retyear" readonly>
			<br><br>
