...
<center><h3>Add Match Summary</h3></center>
...
<center><input type="text" name="cap"  pattern ="[a-z]{1,2}[0-9]{3,}" autofocus required 
...
<center><input type ="number" value ="runs" name="runs" 
placeholder ="Enter runs scored" required min="0" max="400"></center>
<br><br>
