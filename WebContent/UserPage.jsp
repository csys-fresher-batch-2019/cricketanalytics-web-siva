...
<img src="bat.gif" align="right" width="300" height="300">
<body>
	<h1 style="color: blue;">Cricket Analytics</h1>
	...
	<form action="GetDetails">
		...
		Search by name: <input name="playerName" list="Search_by_name_list"
			required>
	...
	<form action="DisplayTopBatsman">
		TopBatsman in: <select name="format">
...
<form action="GetHighScore">
	Pick: <select name="pick">
		...
		<option value="more number of hundreds">More Number of
			Hundreds</option>
